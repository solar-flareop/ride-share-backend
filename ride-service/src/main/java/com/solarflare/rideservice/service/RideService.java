package com.solarflare.rideservice.service;

import com.solarflare.rideservice.dto.RideRequest;
import com.solarflare.rideservice.dto.RideResponse;
import com.solarflare.rideservice.event.RideRequestedEvent;
import com.solarflare.rideservice.model.Ride;
import com.solarflare.rideservice.model.RideStatus;
import com.solarflare.rideservice.repository.RideRepository;
...
public class RideService {
    ...
    private final String RIDE_REQUESTED_TOPIC;
    ...
    public RideResponse requestRide(@Valid RideRequest request) {
        ...
        // Step 2: Publish event to Kafka - Matching service will consume this and find nearest driver
        ...
        //Step 3:Update status to Matching
